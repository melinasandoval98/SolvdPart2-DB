...
public class ComputerProblemTypeDAO implements IComputerProblemTypeDAO {
	...
	private final String INSERT_QUERY = "INSERT INTO Computer_Problem_Types (problem_type) VELUES (?) ";
	private final String UPDATE_QUERY = "UPDATE Computer_Problem_Types SET problem_type = ?";
